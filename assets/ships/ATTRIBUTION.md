...
The `*.svg` top-view schematics in this directory are sourced from the
[Elite Dangerous Almanac](https://github.com/DarkSession/Elite-Dangerous-Almanac),
revision current on 25 August 2026. The Almanac project code and its own asset
work are MIT-licensed; Elite Dangerous ship designs and associated game data
remain the property of Frontier Developments plc and are used for this
