...
ApplicationWindow {
    ...
    component ShadowCard: Item {
        ...
        Rectangle {
            visible: window.enhancedVisuals && shell.accent !== "transparent"
            anchors.fill: parent
            anchors.margins: -2
            anchors.topMargin: 3
        ...
        Rectangle {
            ...
            color: panel
            border.width: 1
            border.color: shell.accent === "transparent" ? borderTone : shell.accent
            Behavior on border.color { enabled: !window.reducedMotion; ColorAnimation { duration: 180 } }
        }
        Rectangle {
            visible: window.enhancedVisuals
            anchors.left: parent.left; anchors.right: parent.right
            anchors.top: parent.top
            anchors.leftMargin: 20; anchors.rightMargin: 26
            height: 1; opacity: 0.28
            gradient: Gradient {
                orientation: Gradient.Horizontal
                GradientStop { position: 0.0; color: "transparent" }
                GradientStop { position: 0.5; color: shell.accent === "transparent" ? accentSecondary : shell.accent }
                GradientStop { position: 1.0; color: "transparent" }
            }
        }
        Item {
    ...
    component CockpitScrollBar: ScrollBar {
        id: themedScrollBar
    ...
    component EmptyState: ColumnLayout {
        ...
        property color tone: cyan
        property bool prominent: false
        spacing: prominent ? 14 : 8
        Rectangle {
            Layout.alignment: Qt.AlignHCenter
            width: parent.prominent ? 86 : 46
            height: parent.prominent ? 86 : 46
            radius: parent.prominent ? 26 : 15
            color: Qt.rgba(parent.tone.r, parent.tone.g, parent.tone.b, 0.10)
            border.width: 1
            border.color: Qt.rgba(parent.tone.r, parent.tone.g, parent.tone.b, 0.42)
            Label {
                anchors.centerIn: parent
                text: parent.parent.symbol
                color: parent.parent.tone
                font.pixelSize: parent.parent.prominent ? 38 : 21
                font.bold: true
            }
        }
        Label {
            ...
            text: parent.title
            color: parent.tone
            font.pixelSize: parent.prominent ? 21 : 13
            font.bold: true
        }
        Label {
            visible: parent.detail.length > 0
            Layout.alignment: Qt.AlignHCenter
            Layout.maximumWidth: parent.prominent ? 720 : 420
            text: parent.detail
            color: muted
            font.pixelSize: parent.prominent ? 14 : 10
            horizontalAlignment: Text.AlignHCenter
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Label {
                            ...
                            text: window.formatSessionDuration(
                                      window.currentSessionSeconds(cockpit.currentSession))
                    ...
                    GridLayout {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                Layout.preferredHeight: 48
                                radius: 9
                                color: active; border.width: 1; border.color: borderTone
                                ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            required property var modelData
                            width: recentSessionList.width; height: 42; radius: 8
                            color: panelRaised
                            RowLayout {
                                ...
                                Label {
                                    text: window.formatSessionDuration(modelData.durationSeconds)
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    Keys.onReturnPressed: {
                        cockpit.selectLogbookEntry(modelData.id)
                        logbookDetailDialog.open()
                    }
                    MouseArea {
                        id: logbookMouse; anchors.fill: parent
                    ...
                    RowLayout {
                        anchors.fill: parent; anchors.margins: 12; spacing: 12
                        Rectangle {
                            width: 118; height: 48; radius: 9; color: active
                            ColumnLayout {
                                anchors.centerIn: parent; spacing: 1
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                ...
                                color: green; font.pixelSize: 9; Layout.fillWidth: true; elide: Text.ElideRight
                            }
                            Label {
